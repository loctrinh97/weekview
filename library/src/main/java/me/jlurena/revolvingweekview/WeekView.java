...
public class WeekView extends View {
    ...
    private int mNowLineColor = Color.parseColor("#0957DE");
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            if (mShowNowLine && isToday) {
                ...
                canvas.drawCircle(start + 20, top, 20, mNowCirclePaint);
                canvas.drawText("Now", startPixel + mWidthPerDay/2 , top -20, mNowTextPaint);
            }
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        for (int i = 0; i < getNumberOfPeriods(); i++) {
            ...
            if (top < getHeight()) {
                canvas.drawText(time, mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight + mHourHeight/2, mTimeTextPaint);
            }
        }
    ...
    @SuppressWarnings("SuspiciousNameCombination") private void init() {
        ...
        mNowCirclePaint.setStrokeWidth(mNowLineThickness);
        mNowCirclePaint.setColor(mNowLineColor);

        mNowTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mNowTextPaint.setStrokeWidth(mNowLineThickness);
        mNowTextPaint.setColor(mNowLineColor);
        mNowTextPaint.setTextSize(25);
